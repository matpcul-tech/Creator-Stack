      ...
      <div className="footer-wrap">
        <div className="footer-top">
          <div className="footer-brand">
            <div className="fl"><span className="c1">Creator</span><span className="c2">Stack</span></div>
          ...
          <div className="footer-cols">
            <div className="footer-col">
              <h4>Products</h4>
              <ul>
                <li><a href="#tools">Creator OS — from $29/mo</a></li>
                <li><a href="#tools">Prompt Architect — from $19/mo</a></li>
                <li><a href="#tools">Manuscript Studio — from $19/mo</a></li>
              </ul>
            </div>
            <div className="footer-col">
              <h4>Company</h4>
