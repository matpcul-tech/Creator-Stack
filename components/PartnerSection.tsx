...
import { PARTNER_EMAIL, FORMSPREE_ENDPOINT } from '@/lib/links'
      ...
      <div className="container">
        <div className="partner-inner">
          <div className="partner-text">
            ...
            <p><strong>Ideal partners:</strong> creator economy platforms, AI writing tool companies, edtech or publishing SaaS looking to expand into creator tooling, strategic acquirers in the $5M–$25M range.</p>
            <a
              href={PARTNER_EMAIL}
              className="btn-main"
          ...
          <div className="partner-form">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                style={submitted ? { background: '#1A2E2A', color: 'var(--teal)' } : {}}
              >
                {submitted ? 'Inquiry Sent ✓' : submitting ? 'Sending…' : 'Send Inquiry'}
              </button>
              <p
                className="pf-note"
                style={submitted ? { color: 'var(--teal)' } : {}}
              >
                {submitted
