...
import { PROMPT_ARCHITECT_URL, MANUSCRIPT_STUDIO_URL } from '@/lib/links'
  ...
  return (
    <section id="pricing">
      <div className="container">
        ...
        <p className="sec-sub">One subscription covers the full stack. Upgrade when your output demands it — or stay free until it does.</p>
        ...
        <div className="price-toggle">
          ...
          <div
            ...
            tabIndex={0}
            onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && setAnnual(!annual)}
          >
        ...
        <div className="price-grid">
          ...
          <div className="pc featured">
            ...
            <p className="pc-period">
              {annual ? 'per month, billed $348/yr' : 'per month'}
            </p>
            <ul className="pc-list">
          ...
          <div className="pc">
            ...
            <p className="pc-period">
              {annual ? 'per month, billed $708/yr' : 'per month'}
            </p>
            <ul className="pc-list">
